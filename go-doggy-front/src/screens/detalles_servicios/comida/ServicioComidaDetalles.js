...
export default function Servicio_Detalles_Comida({ route, navigation }) {
  ...
  const productoData = producto || {
    ...
    peso: "15 kg",
    descripcion:
      "Alimento premium de alta calidad especialmente formulado para perros adultos con necesidades nutricionales completas. Contiene proteínas de calidad, vitaminas y minerales esenciales para la salud óptima de tu mascota.",
    ingredientes:
      "Pollo deshidratado, Arroz integral, Grasas animales, Vitaminas (A, D, E), Minerales (calcio, fósforo, zinc)",
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        {/* FOTO PRODUCTO */}
        <Image source={productoData.imagen} style={styles.productoImage} />
