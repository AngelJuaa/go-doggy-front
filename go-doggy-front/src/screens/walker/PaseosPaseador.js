                ...
                {p.estado === "completado" && (
                  <View style={styles.buttonRow}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => navigation.navigate("VerReciboPaseador", { servicioId: p.servicio_id })}
                    >
...
const styles = StyleSheet.create({
  ...
  buttonRow: { flexDirection: "row", justifyContent: "space-between", gap: s(8), marginTop: vs(8) },
  rutaBtn: { flex: 1, backgroundColor: "#99D9C1", borderRadius: s(10), padding: s(8), alignItems: "center" },
  rutaBtnText: { color: "#fff", fontWeight: "bold", fontSize: ms(12) },
  reciboBtn: { flex: 1, backgroundColor: "#4A90E2", borderRadius: s(10), padding: s(8), alignItems: "center" },
  reciboBtnText: { color: "#fff", fontWeight: "bold", fontSize: ms(12) },
