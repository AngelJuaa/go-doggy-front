...
export const styles = StyleSheet.create({
	...
	input: { borderBottomWidth: 1, borderBottomColor: "#000", fontSize: ms(18), paddingVertical: vs(6), minHeight: vs(44), color: "#000" },
	codeInput: { fontSize: ms(22), letterSpacing: 4, textAlign: "center" },
	...
	secondaryButton: { alignItems: "center", marginTop: vs(14), padding: s(6) },
	secondaryText: { fontSize: ms(12), color: "#555", textDecorationLine: "underline", textAlign: "center" },
});
