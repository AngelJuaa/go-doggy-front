...
export default function Servicio_Detalles_Ofertas({ route, navigation }) {
  ...
  const ofertaData = oferta || {
    ...
    descripcion:
      "Oferta especial flash: Alimento premium para perros adultos con descuento del 50%. Stock limitado, ¡apúrate! Esta es una oferta por tiempo limitado de nuestro mejor alimento.",
    especificaciones:
      "Peso: 15 kg, Marca: PetNutrition Pro, Ingredientes naturales sin conservantes",
    stock_disponible: "12 unidades",
    duracion_oferta: "Válida hasta el 5 de Mayo de 2026",
    tiempo_restante: "3 días, 14 horas",
    beneficios:
      "Proteína de calidad, Vitaminas y minerales esenciales, Grasas saludables para pelaje brillante",
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        {/* FOTO OFERTA */}
        <Image source={ofertaData.imagen} style={styles.ofertaImage} />
