...
export default function Servicio_Detalles_Paseador({ route, navigation }) {
  ...
  const paseadorData = paseador || {
    ...
    biografia:
      "Soy una apasionada de los perros con más de 10 años de experiencia en paseos y cuidado. Me encanta pasar tiempo al aire libre y hacer que cada mascota disfrute de su tiempo conmigo. Ofrezco paseos personalizados adaptados a las necesidades de tu perro.",
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        {/* FOTO PASEADOR */}
        <Image source={paseadorData.imagen} style={styles.paseadorImage} />
