...
export default function Servicio_Detalles_Accesorios({ route, navigation }) {
  ...
  const accesorioData = accesorio || {
    ...
    descripcion:
      "Correa premium de cuero genuino, ajustable y cómoda para paseos diarios. Diseñada ergonómicamente para mayor comodidad del dueño y seguridad del perro.",
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        {/* FOTO ACCESORIO */}
        <Image source={accesorioData.imagen} style={styles.accesorioImage} />
        ...
        <View style={styles.detailsContainer}>
          ...
          <Text style={styles.detailValue}>
            {accesorioData.colores_disponibles}
          </Text>
          ...
          <Text style={styles.detailValue}>
            {accesorioData.especificaciones}
          </Text>
