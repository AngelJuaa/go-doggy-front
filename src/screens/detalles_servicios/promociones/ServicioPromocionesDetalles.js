...
export default function Servicio_Detalles_Promociones({ route, navigation }) {
  ...
  const promocionData = promocion || {
    ...
    descripcion:
      "Paquete especial de 5 paseos diarios con nuestros paseadores profesionales. Disfruta de un 20% de descuento en esta promoción limitada.",
    incluye:
      "5 paseos de 30 minutos cada uno, Reportes fotográficos diarios, Atención personalizada",
    validez: "30 días desde la compra",
    vencimiento: "31 de Mayo de 2026",
    codigo_promocional: "PASEOS20",
    condiciones:
      "No acumulable con otras promociones. Válido solo para nuevos clientes.",
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        {/* FOTO PROMOCION */}
        <Image source={promocionData.imagen} style={styles.promocionImage} />
        ...
        <View style={styles.priceContainer}>
          <Text style={styles.precioOriginal}>
            {promocionData.precio_original}
          </Text>
          <Text style={styles.precioDescuento}>
            {promocionData.precio_descuento}
          </Text>
        </View>
        ...
        <View style={styles.detailsContainer}>
          ...
          <Text style={styles.codigoPromocional}>
            {promocionData.codigo_promocional}
          </Text>
