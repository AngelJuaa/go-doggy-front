...
export default function Servicio_Detalles_Estetica({ route, navigation }) {
  ...
  const servicioData = servicio || {
    ...
    duracion: "45 minutos",
    descripcion:
      "Servicio completo de baño profesional con productos premium para el cuidado de la piel y pelaje de tu perro. Incluye secado meticuloso y cepillado final.",
    productos_usados:
      "Champú hipoalergénico, Acondicionador naturista, Sérum para brillo",
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        {/* FOTO SERVICIO */}
        <Image source={servicioData.imagen} style={styles.servicioImage} />
